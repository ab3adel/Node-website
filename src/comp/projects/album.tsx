...
interface iprops {subject:string[],id:string}
          ...
          if (changingImage && !wait  ){
              if (e.type === 'mousemove'){
                 ...
                 if (pointsList.length===5 && e.type === 'mousemove'){
                  let img1=document.getElementsByClassName('frontImage')[0] as HTMLImageElement
                   if (props.id === "js"){
                    img1=document.getElementsByClassName('frontImage')[1] as HTMLImageElement
                   }
  ...
  if(!Image.complete) {
    ...
    return (
        ...
        { visible?<React.Fragment>
                    <img id="albumItem" className="frontImage" src={props.subject[0]} 
