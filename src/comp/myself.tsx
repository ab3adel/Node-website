...
import mygif from '../images/ana.gif'
import { UnknownReturnType,Selection } from 'd3'
    ...
    return (
        ...
        <img src={b3d} id="me"/>
          ...
          <div className="meDown">
            <p className="wise"> coding like a magic ,Throw  some incantaions and the dead become <span>live</span> again! </p>
